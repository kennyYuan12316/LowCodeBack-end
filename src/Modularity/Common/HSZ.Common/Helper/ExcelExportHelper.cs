        ...
        private static MemoryStream ExportMemoryStream(List<T> list, ExcelConfig excelConfig)
        {
            try
            {
                ...
                #region 右击文件 属性信息
                {
                    ...
                    si.Author = "江西合力泰科技股份有限公司"; //填加xls文件作者信息
                    si.ApplicationName = "江西合力泰科技股份有限公司"; //填加xls文件创建程序信息
                    si.LastAuthor = "江西合力泰科技股份有限公司"; //填加xls文件最后保存者信息
                    si.Comments = "江西合力泰科技股份有限公司"; //填加xls文件作者信息
                ...
                if (excelConfig.Background != new Color())
                {
                    if (excelConfig.Background != new Color())
                    {
                        ...
                        cHeadStyle.FillForegroundColor = GetXLColour(workbook, excelConfig.Background);
                    }
                }
                ...
                if (excelConfig.ForeColor != new Color())
                {
                    cfont.Color = GetXLColour(workbook, excelConfig.ForeColor);
                }
                ...
                if (list != null)
                {
                    foreach (T item in list)
                    {
                        ...
                        if ((rowIndex % 65536) == 0)
                        {
                            if (rowIndex != 0)
                            {
                                ...
                                foreach (var cell in headerRow.Cells)
                                {
                                    ...
                                    int length = Encoding.Default.GetBytes(drValue).Length + 1;
                        ...
                        {
                            int columnWidth = sheet.GetColumnWidth(ordinal) / 256;
                            ...
                            if (colunValue != null)
                            {
                                ...
                                sheet.SetColumnWidth(ordinal, columnWidth * 256);
                                ordinal++;
                            }
                        }
                        #endregion
