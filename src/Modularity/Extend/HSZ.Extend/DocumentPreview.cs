...
using HSZ.Extend.Entitys.Dto.DocumentPreview;
    ...
    public class DocumentPreview : IDynamicApiController, ITransient
    {
        ...
        public dynamic DocumentPreview_Api(string fileId, [FromQuery] DocumentPreviewPreviewInput input)
        {
            ...
            if (file != null)
            {
                ...
                var yozoUrl = App.Configuration["HSZ_APP:YOZO:domain"];
                var yozoKey = App.Configuration["HSZ_APP:YOZO:domainKey"];
        ...
        public dynamic PreviewLocalFile(string fileId)
        {
            ...
            //return ce.office.extension.ExcelHelper.ToHtml(@"E:\1.SourceCode\ZLCloud\zlcloud-resources\DocumentPreview\报价单.xls");
