...
using HSZ.WorkFlow.Entitys.Dto.WorkFlowForm.BatchPack;
...
namespace HSZ.WorkFlow.WorkFlowForm
{
    ...
    public class BatchPackService : IBatchPackService, IDynamicApiController, ITransient
    {
        ...
        public BatchPackService(ISqlSugarRepository<BatchPackEntity> sqlSugarRepository, IBillRullService billRuleService,
        ...
        {
            var data = (await _sqlSugarRepository.GetFirstAsync(x => x.Id == id)).Adapt<BatchPackInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, BatchPackEntity entity, Dictionary<string, List<string>> candidateList)
        {
            try
            {
                Db.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<BatchPackUpInput>(), 0, 0, true,false, candidateList);
                #endregion
