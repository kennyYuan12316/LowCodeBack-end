...
using HSZ.WorkFlow.Entitys.Dto.WorkFlowForm.ArticlesWarehous;
...
namespace HSZ.WorkFlow.WorkFlowForm
{
    ...
    public class ArticlesWarehousService : IArticlesWarehousService, IDynamicApiController, ITransient
    {
        ...
        public ArticlesWarehousService(ISqlSugarRepository<ArticlesWarehousEntity> sqlSugarRepository,
        ...
        {
            var data = (await _sqlSugarRepository.GetFirstAsync(x => x.Id == id)).Adapt<ArticlesWarehousInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, ArticlesWarehousEntity entity, Dictionary<string, List<string>> candidateList)
        {
            try
            {
                Db.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<ArticlesWarehousUpInput>(), 0, 0, true,false, candidateList);
                #endregion
