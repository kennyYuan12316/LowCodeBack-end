...
using HSZ.WorkFlow.Entitys.Dto.WorkFlowForm.PostBatchTab;
...
namespace HSZ.WorkFlow.WorkFlowForm
{
    ...
    public class PostBatchTabService : IPostBatchTabService, IDynamicApiController, ITransient
    {
        ...
        public PostBatchTabService(ISqlSugarRepository<PostBatchTabEntity> sqlSugarRepository, 
        ...
        {
            var data = (await _sqlSugarRepository.GetFirstAsync(x => x.Id == id)).Adapt<PostBatchTabInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, PostBatchTabEntity entity, Dictionary<string, List<string>> candidateList)
        {
            try
            {
                Db.BeginTran();
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<PostBatchTabUpInput>(), 0, 0, true, false, candidateList);
                #endregion
