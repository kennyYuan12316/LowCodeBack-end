...
using HSZ.WorkFlow.Entitys.Dto.WorkFlowForm.LeaveApply;
...
namespace HSZ.WorkFlow.WorkFlowForm
{
    ...
    public class LeaveApplyService : ILeaveApplyService, IDynamicApiController, ITransient
    {
        ...
        public LeaveApplyService(ISqlSugarRepository<LeaveApplyEntity> sqlSugarRepository, IBillRullService billRuleService,
        ...
        {
            var data = (await _sqlSugarRepository.GetFirstAsync(x => x.Id == id)).Adapt<LeaveApplyInfoOutput>();
            return data;
        }
        #endregion
        ...
        private async Task Submit(string id, LeaveApplyEntity entity, Dictionary<string, List<string>> candidateList)
        {
            try
            {
                ...
                #region 流程信息
                await _flowTaskService.Submit(id, entity.FlowId, entity.Id, entity.FlowTitle, entity.FlowUrgent, entity.BillNo, entity.Adapt<LeaveApplyUpInput>(), 0, 0, true, false, candidateList);
                #endregion
