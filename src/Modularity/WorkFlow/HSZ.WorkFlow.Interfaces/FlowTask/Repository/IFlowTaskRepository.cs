...
namespace HSZ.WorkFlow.Interfaces.FlowTask.Repository
{
    /// <summary>
    ...
    public interface IFlowTaskRepository
    {
        ...
        /// <returns></returns>
        Task<List<FlowTaskEntity>> GetTaskList(List<string> ids);
        ...
        /// <param name="entitys"></param>
        /// <returns></returns>
        Task<int> UpdateTaskNode(List<FlowTaskNodeEntity> entitys);
        ...
        /// <returns></returns>
        Task<List<FlowTaskOperatorEntity>> GetTaskOperatorList(Expression<Func<FlowTaskOperatorEntity, bool>> expression);
        ...
        /// <returns></returns>
        List<FlowTaskOperatorEntity> GetTaskOperatorList(string taskId, string[] taskNodeIds);
        ...
        void DeleteFlowCandidates(List<string> nodeId);

        /// <summary>
        /// 候选人删除
        /// </summary>
        /// <param name="nodeId"></param>
        void DeleteFlowCandidates(string nodeId, string hanldId, string operatorId);
        ...
        /// </summary>
        /// <param name="ids"></param>
        void DeleteFlowCandidates(string[] ids);
