...
namespace Zjn.Siem
{
    ...
    public class PackStatusD:PackBase
    {
        ...
        /// 目标设备S
        /// </summary>
        [DisplayName("目标1S"), Description("字符串"), JsonIgnore()]
        ...
        /// 目标设备S
        /// </summary>
        [DisplayName("目标2S"), Description("字符串"), JsonIgnore()]
        ...
        /// 托盘编码S
        /// </summary>
        [DisplayName("托盘1S"), Description("字符串"), JsonIgnore()]
        ...
        /// 托盘编码S
        /// </summary>
        [DisplayName("托盘2S"), Description("字符串"), JsonIgnore()]
