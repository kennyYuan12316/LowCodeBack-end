...
        Task<int> Delete(MessageEntity entity);
        ...
        int Create(MessageEntity entity, List<MessageReceiveEntity> receiveEntityList);
        ...
        /// <param name="entity">实体对象</param>
        /// <param name="receiveEntityList">收件用户</param>
        int Update(MessageEntity entity, List<MessageReceiveEntity> receiveEntityList);
