...
namespace HSZ.Wms.ZjnWorkProsess
{
    ...
    public class FireControlProcess : IFireControlProcess, ITransient
    {
        ...
        /// <returns></returns>
        public async Task<ZjnWmsTaskDetailsInfoOutput> FireControlStart(ZjnWmsTaskDetailsEntity WmsTaskData, int TaskState, TaskResultPubilcParameter parameter)
        {
