...
namespace HSZ.Wms.ZjnWorkProsess
{
    ...
    public class ElevatorProcess : IElevatorProcess, ITransient
    {
        ...
        /// <returns></returns>
        public async Task<ZjnWmsTaskDetailsInfoOutput> HoistMoveStart(ZjnWmsTaskDetailsEntity WmsTaskData, int TaskState, TaskResultPubilcParameter parameter)
        {
