...
namespace HSZ.Wms.ZjnWorkProsess
{
    ...
    public class FrameMemberWarehousInProcess : IWarehousInProcess, ITransient
    {
        ...
        public FrameMemberWarehousInProcess(
        ...
        /// <returns></returns>
        public async Task<ZjnWmsTaskDetailsInfoOutput> WarehousingStationTask(ZjnWmsTaskDetailsEntity WmsTaskData, int TaskState, TaskResultPubilcParameter parameter = null)
        {
