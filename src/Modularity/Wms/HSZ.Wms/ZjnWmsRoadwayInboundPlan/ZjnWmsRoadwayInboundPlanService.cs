...
namespace HSZ.wms.ZjnWmsRoadwayInboundPlan
{
    /// <summary>
    /// 巷道入库策略均衡服务
    /// </summary>
    [ApiDescriptionSettings(Tag = "wms",Name = "ZjnWmsRoadwayInboundPlan", Order = 200)]
    ...
    public class ZjnWmsRoadwayInboundPlanService : IZjnWmsRoadwayInboundPlanService, IDynamicApiController, ITransient
    {
        ...
        private readonly ISqlSugarRepository<ZjnWmsRoadwayGroupEntity> _zjnRoadwayGroupEntity;
        private readonly ISqlSugarRepository<ZjnWmsRoadwayGroupDetailsEntity> _zjnRoadwayGroupDetailsEntity;
        ...
        /// </summary>
        public ZjnWmsRoadwayInboundPlanService(ISqlSugarRepository<ZjnWmsRoadwayInboundPlanEntity> zjnRoadwayInboundPlanRepository, ISqlSugarRepository<ZjnWmsRoadwayGroupEntity> zjnRoadwayGroupEntity,
            ISqlSugarRepository<ZjnWmsRoadwayGroupDetailsEntity> zjnRoadwayGroupDetailsEntity, IUserManager userManager)
        {
