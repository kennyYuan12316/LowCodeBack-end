...
namespace HSZ.Wms.Interfaces.ZjnWorkProsess
{
    ...
    /// AGV业务处理
    /// </summary>
    public interface IAgvDeviceProcess
    {
        /// <summary>
        /// AGV业务处理
        /// </summary>
        ...
        /// <returns></returns>
        public Task<ZjnWmsTaskDetailsInfoOutput> AgvDetailStart(ZjnWmsTaskDetailsEntity WmsTaskData, int TaskState, TaskResultPubilcParameter parameter);
    }
}
