...
namespace HSZ.Entitys.wms
{
    ...
    /// 库存结构分析（集成）
    /// </summary>
    [SugarTable("zjn_report_productstructure_pack")]
    [Tenant(ClaimConst.TENANT_ID)]
    public class ZjnReportProductstructurePackEntity
    {
        /// <summary>
        /// F_Id
        /// </summary>
        ...
        /// 电池型号
        /// </summary>
        [SugarColumn(ColumnName = "F_BatteryType")]        
        public string BatteryType { get; set; }
        
        /// <summary>
        /// 电池数量
        /// </summary>
        [SugarColumn(ColumnName = "F_BatteryCount")]        
