...
namespace HSZ.Entitys.wms
{
    ...
    /// 巷道信息
    /// </summary>
    [SugarTable("zjn_wms_aisle")]
    [Tenant(ClaimConst.TENANT_ID)]
    public class ZjnWmsAisleEntity
    {
        /// <summary>
        /// 唯一ID
        /// </summary>
        ...
        /// 堆垛机作业模式
        /// </summary>
        [SugarColumn(ColumnName = "F_StackerWorkType")]
        public int? StackerWorkType { get; set; }


        /// <summary>
        /// 堆垛机当前作业顺序  1.入 2.出 3.移
        /// </summary>
        [SugarColumn(ColumnName = "F_StackerWorkNo")]
        public int? StackerWorkNo { get; set; }
