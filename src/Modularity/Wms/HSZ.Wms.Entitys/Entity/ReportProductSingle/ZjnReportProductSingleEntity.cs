...
namespace HSZ.Entitys.wms
{
    ...
    /// 成品库单体
    /// </summary>
    [SugarTable("zjn_report_product_single")]
    [Tenant(ClaimConst.TENANT_ID)]
    public class ZjnReportProductSingleEntity
    {
        /// <summary>
        /// F_Id
        /// </summary>
        ...
        /// 首次入库时间
        /// </summary>
        [SugarColumn(ColumnName = "F_EntryTimeFitrst")]        
        public DateTime? EntryTimeFitrst { get; set; }
