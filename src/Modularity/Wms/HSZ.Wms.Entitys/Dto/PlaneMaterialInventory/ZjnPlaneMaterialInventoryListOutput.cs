...
namespace HSZ.wms.Entitys.Dto.ZjnPlaneMaterialInventory
{
    ...
    /// 库存信息数据源输入参数
    /// </summary>
    public class ZjnPlaneMaterialInventoryListOutput
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        /// 客户
        /// </summary>
        public string F_ProductsCustomer { get; set; }
        ...
        /// 经验类型
        /// </summary>
        public string F_ProductsCheckType { get; set; }
        
        /// <summary>
        /// 是否锁定
        /// </summary>
        public int? F_ProductsIsLock { get; set; }
        
        /// <summary>
        /// 上次盘点时间
        /// </summary>
        public DateTime? F_ProductsTakeStockTime { get; set; }
        
        /// <summary>
        /// 盘点次数
        /// </summary>
        public int? F_ProductsTakeCount { get; set; }
