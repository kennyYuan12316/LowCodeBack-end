...
namespace ZJN.Plc.PlcHelper
{
    ...
    /// PLC堆垛机控制包，读，48 Byte
    /// </summary>
    public class PackStackerRead : PackBase
    {
        /// <summary>
        /// 堆垛机编码
        /// </summary>
        ...
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留1"), PackStart(36), PackLength(2), Category("PLC报文"), Description("12 Byte")]
        ...
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留3"), PackStart(40), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve3 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留4"), PackStart(42), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve4 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留5"), PackStart(44), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve5 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留6"), PackStart(46), PackLength(2), Category("PLC报文"), Description("12 Byte")]
