...
namespace ZJN.Plc.PlcHelper
{
    ...
    public class PackRead : PackBase
    {
        ...
        /// 托盘条码
        /// </summary>
        [DisplayName("托盘条码"), PackStart(20), PackLength(20), Category("PLC报文"), Description("32 Byte,类型为S7String")]
        ...
        ///// Agv交互
        ///// </summary>
        //[DisplayName("AGV交互"), PackStart(45), PackLength(2), Category("PLC报文"), Description("2 Byte")]
