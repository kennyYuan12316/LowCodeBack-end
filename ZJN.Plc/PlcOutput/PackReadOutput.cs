...
namespace ZJN.Plc.PlcHelper
{
    ...
    public class PackReadOutput 
    {
        ...
        public string DeviceCode_S { set; get; }
        ...
        public string TargetPosition_S { set; get; }

        /// <summary>
        /// 托盘编码S
        /// </summary>
        [DisplayName("托盘编码S"), Description("字符串")]
        public string TrayCode_S { set; get; }
        ...
        /// 预留1
        /// </summary>
        [DisplayName("预留1"), PackStart(44), PackLength(4), Category("PLC报文"), Description("4 Byte")]
    ...
    /// DB包列表
    /// </summary>
    public class PackReadListOutput
    {
        public PackReadListOutput(int count)
        {
            this.List = new PackReadOutput[count];
        }

        public PackReadOutput[] List { set; get; }
    }
}
