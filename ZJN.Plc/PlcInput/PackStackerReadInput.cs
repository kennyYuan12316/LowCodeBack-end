...
namespace ZJN.Plc.PlcHelper
{
    ...
    /// 单工位PLC堆垛机输出类
    /// </summary>
    public class PackStackerReadInput
    {
        /// <summary>
        /// 堆垛机编码
        /// </summary>
        ...
        /// 预留1,7 bit
        /// </summary>
        [DisplayName("预留1"), PackStart(1), PackLength(0.125), Category("PLC报文"), Description("7 bit")]
        ...
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留2"), PackStart(36), PackLength(2), Category("PLC报文"), Description("12 Byte")]
        public short Reserve2 { set; get; }

        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留2"), PackStart(38), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve3 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留2"), PackStart(40), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve4 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留2"), PackStart(42), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve5 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留2"), PackStart(44), PackLength(2), Category("PLC报文"), Description("2 Byte")]
        public short Reserve6 { set; get; }
        /// <summary>
        /// 预留1,6 short
        /// </summary>
        [DisplayName("预留2"), PackStart(46), PackLength(2), Category("PLC报文"), Description("12 Byte")]
        public short Reserve7 { set; get; }
    }
}
